...
from company_knowledge_rag.domain.schemas import Chunk, DocumentStatus, Principal, SearchHit
...
class MemoryChunkStore:
    ...
    def search(self, query: str, principal: Principal, limit: int = 5) -> list[SearchHit]:
        ...
        authorized = [
            ...
            if chunk.status is DocumentStatus.READY and chunk.allowed_roles & principal.roles
        ]
        scored = [
