...
def test_settings_ignores_legacy_prefixed_main_provider(monkeypatch) -> None:
    monkeypatch.setenv("RAG_MAIN_PROVIDER", "openrouter")

    settings = Settings(_env_file=None)

    assert settings.main_provider == "gemini"
